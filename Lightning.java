 ...
 * 
 * 
 * THIS IS A PLACEHOLDER ATTACK!!! IT IS REALLY STUPID!!!
 * 
 * 
 * 
 * 
 ...
 * @version 2024-05-16
 */
public class Lightning extends PhysicsObject
{
    int beanTimer = 0;
    int throwerNumber;
    PolarBear thrower;
    ...
    public Lightning(double x, double y, double xVelocity, double yVelocity, int creator, int beanNumber) {
        super(x, y);
    ...
    private void updateImage() {
        imageName = "lightning" + explosionTimer / 4 + ".png";
    }
    ...
    private void checkHit() {
        thrower = (PolarBear) ((Map) getWorld()).getPlayer(throwerNumber);
